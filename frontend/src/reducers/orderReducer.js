...
// for delete orders by user which created by them
export const deleteUserOrderReducer = (state = {}, action) => {
  switch (action.type) {
    ...
    case DELETE_USER_ORDERS_FAIL:
      return {
        ...state,
        loading: false,
        error: action.payload,
      };
    case DELETE_USER_ORDERS_RESET:
      return {
        ...state,
        isDeleted: false,
      };
